...
exports.getOrderStatusUpdateEmail = exports.getOrderConfirmationEmail = void 0;
...
const getOrderStatusUpdateEmail = (data) => `
  <div style="font-family: Arial, sans-serif; padding: 30px; color: #111827; background-color: #f9fafb; border-radius: 12px; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb;">
...
`;
exports.getOrderStatusUpdateEmail = getOrderStatusUpdateEmail;
